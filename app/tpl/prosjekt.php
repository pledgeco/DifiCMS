...
<div class="content" style="margin-top:-30px; margin-bottom:-1px;">
            ...
            <h2 style="color:#2e7297; font-size:20px;">Prosjektnavn: <?php echo htmlspecialchars($udata['username']); ?></h2><br />
</div>
...
<b>Sist pålogget:</b><br />
<?php
$timestamp=$udata['last_online'];
