...
<div class="content" style="margin-top:-30px; margin-bottom:-1px;">
            ...
            <h2 style="color:#2e7297; font-size:20px;">Prosjektfase: BP2</h2><br />
</div>
...
<div style="text-align:center; width:100%">
    <div id="pv_modell">
      <div class="pv_menu_1">
        ...
        <a href="/BP2" class="bp_1"><img src="images/bp_1.png" alt="Beslutningspunkt 1" class="tooltip" title="Beslutningspunkt 1" /></a>
...
<br />
  ...
  <div id="inside-wrap">
        <div id="left-wrapper">
         <div class="content">
            ...
            <h2 style="color:#2e7297; margin-top:9px; font-size:16px; margin-bottom:10px;">Last opp dokumenter til BP2</h2><br />
 ...
 <a class="button" href="/planlegging" style="float:right; margin-right:70px;">› Neste fase</a>
 </form>
</div>
         ...
         <div id="right-wrapper">
          <div class="content">
            <img src="http://prosjektdatabasen.com/images/circle-new.png"/ alt="" >
            <h2 style="color:#2e7297; margin-top:9px; font-size:16px; margin-bottom:10px;">Dine dokumenter i BP2</h2><br />
        <table>
    <tr>
    <th>Filnavn</th>
    <th>Filtype</th>
...
<?php
     $my_id = $_SESSION['user']['id'];
 $sql="SELECT * FROM tbl_uploads WHERE fase = 3 AND user_id = '$my_id'";
 ...
 while($row=mysql_fetch_array($result_set))
 {
  ?>
        ...
        <td>
        <a href="uploads/<?php echo $row['file'] ?>" target="_blank" download="uploads/<?php echo $row['file'] ?>" style="text-align:center;"> 
            <img src="/images/download.png"  style=""></a>
