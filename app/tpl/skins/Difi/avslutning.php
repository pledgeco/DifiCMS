...
<div class="content" style="margin-top:-30px; margin-bottom:-1px;">
            ...
            <h2 style="color:#2e7297; font-size:20px;">Prosjektfase: Avslutning</h2><br />
</div>
...
<br />
  ...
  <div id="inside-wrap">
        <div id="left-wrapper">
         <div class="content">
            ...
            <h2 style="color:#2e7297; margin-top:9px; font-size:16px; margin-bottom:10px;">Last opp dokumenter til avslutningsfasen</h2><br />
 ...
 <button type="submit" name="btn-upload">Last opp</button>
  <a class="button" href="/bp5" style="float:right; margin-right:70px;">› Neste fase</a>
 </form>
</div>
         ...
         <div id="right-wrapper">
          <div class="content">
            <img src="http://prosjektdatabasen.com/images/circle-new.png"/ alt="" >
            <h2 style="color:#2e7297; margin-top:9px; font-size:16px; margin-bottom:10px;">Dine dokumenter i avslutningsfasen</h2><br />
        <table>
    <tr>
    <th>Filnavn</th>
    <th>Filtype</th>
...
<?php
     $my_id = $_SESSION['user']['id'];
 $sql="SELECT * FROM tbl_uploads WHERE fase = 8 AND user_id = '$my_id'";
