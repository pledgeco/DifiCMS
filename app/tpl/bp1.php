...
#pv_modell a.bp_6 {z-index:10; position:relative; top:-40px; left:85px;} 
...
<div class="content">
            ...
            <h2 style="color:#2e7297; font-size:20px; margin-bottom:10px; margin-top:10p;">Prosjektfase: BP1</h2><br />
</div>
    ...
    <div id="pv_modell">
      <div class="pv_menu_1">
        ...
        <div class="pv_menu_text_first">
          ...
          <a class="small_text_blue" style="margin-left:16px;" href="konseptfasn">Idé, Behov, Mål</a>        </div>
      ...
      <div class="pv_menu_4">
        ...
        <div class="pv_menu_text">
          ...
          <a class="small_text_green" href="avslut">Overlevering, Evaluering</a>        </div>
      ...
      <div class="pv_menu_5">
        ...
        <div class="pv_menu_text">
          ...
          <a class="small_text_blue" href="realingseringsplan">Gevinster</a>        </div>

        <a href="/realiseringsfasen/bp6" class="bp_6"><img src="images/bp_6.png" alt="Beslutningspunkt 6" class="tooltip" title="Beslutningspunkt 6" />
        </a>
...
<br /><br />
  ...
  <div id="inside-wrap">
        <div id="left-wrapper">
         <div class="content">
            ...
            <h2 style="color:#2e7297; margin-top:9px; font-size:16px; margin-bottom:10px;">Last opp dokumenter til BP1</h2><br />
            Til høyre vil du se en oversikt over de filene du laster opp. Du kan laste ned filene som lagres. Om du ønsker å fjerne en
            ...
            <text style="font-size:16px;"><b>1.</b></text> Trykk på «Velg fil»<br /><br />
            <text style="font-size:16px;"><b>2.</b></text> Velg filen du ønsker å laste opp<br /><br />
            <text style="font-size:16px;"><b>3.</b></text> Trykk på «Last opp»</h2>
            <br /><br />
             <div id="body">
 ...
 <button type="submit" name="btn-upload">Last opp</button>
         ...
         <div id="right-wrapper">
          <div class="content">
            <img src="http://prosjektdatabasen.com/images/circle-new.png"/ alt="" >
            <h2 style="color:#2e7297; margin-top:9px; font-size:16px; margin-bottom:10px;">Dine dokumenter i BP1</h2><br />
        <table>
    <tr>
    <th>Filnavn</th>
    <th>Filtype</th>
...
<?php
     $my_id = $_SESSION['user']['id'];
 $sql="SELECT * FROM tbl_uploads WHERE fase = 1 AND user_id = '$my_id'";
 ...
 while($row=mysql_fetch_array($result_set))
 {
  ?>
        ...
        <td>
          <a href="uploads/<?php echo $row['file'] ?>" target="_blank" download="uploads/<?php echo $row['file'] ?>"> <img src="/images/download.png"  style="margin-left: 6px;"></a>
