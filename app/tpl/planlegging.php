...
<div class="content" style="margin-top:-30px; margin-bottom:-1px;">
            ...
            <h2 style="color:#2e7297; font-size:20px;">Prosjektfase: Planlegge</h2><br />
</div>
...
<br />
  ...
  <div id="inside-wrap">
        <div id="left-wrapper">
         <div class="content">
            ...
            <h2 style="color:#2e7297; margin-top:9px; font-size:16px; margin-bottom:10px;">Last opp dokumenter til planleggingsfasen</h2><br />
 ...
 <button type="submit" name="btn-upload">Last opp</button>
         ...
         <div id="right-wrapper">
          <div class="content">
            <img src="http://prosjektdatabasen.com/images/circle-new.png"/ alt="" >
            <h2 style="color:#2e7297; margin-top:9px; font-size:16px; margin-bottom:10px;">Dine dokumenter i planleggingsfasen</h2><br />
        <table>
    <tr>
    <th>Filnavn</th>
    <th>Filtype</th>
...
<?php
     $my_id = $_SESSION['user']['id'];
 $sql="SELECT * FROM tbl_uploads WHERE fase = 4 AND user_id = '$my_id'";
 ...
 while($row=mysql_fetch_array($result_set))
 {
  ?>
        ...
        <td>
          <a href="uploads/<?php echo $row['file'] ?>" target="_blank" download="uploads/<?php echo $row['file'] ?>"> <img src="/images/download.png"  style="margin-left:12px;"></a>
